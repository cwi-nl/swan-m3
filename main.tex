...
\title{{\huge $M^3$: An Open Model for Source Code Analytics in Rascal}}
...
in the quality of open-source projects from all possible perspectives, including product, process and community. 

The main two challenges that our part of the design, which focuses on source code, faces
...
\emph{The main threat to validity of any intermediate model which is generic enough to be reusable between different programming languages is that important details may be lost. This is why the \mthree standard prescribes language specific AST models and language agnostic relational models where possible.}
