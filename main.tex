...
can be de-coupled from model consumers (metrics \& visuals). Examples of such intermediate models are FAMIX~\cite{famix}, RSF~\cite{rsf}, GXL~\cite{GXL}, and KDM~\cite{KDM}, ATerms~\cite{BJKO00} and
